...
//zz add
@protocol OHMySQLStoreCoordinatorProtocol <NSObject>
@optional
//连接失败回调
- (void)oHMySQLStoreCoordinatorConnectDBFailed;
...
//zz add
@property (nonatomic, weak) id<OHMySQLStoreCoordinatorProtocol> delegate;
